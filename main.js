...
var B = class {
  ...
  Rt() {
    ...
    this.Pt(), i.forEach((i2, e2) => {
      ...
      !t && null !== h2 && i2.It() && null !== a2 ? (r2.vt = h2.zt, r2.ft = h2.ft, r2.ct = h2.Ot, r2.ot[0].Mt = h2.Mt, r2.ot[0].ut = i2.Ft().Nt(h2.Mt, a2.Wt), r2.dt = (_a2 = h2.Ht) != null ? _a2 : this.O.Ut(r2.ot[0].ut / i2.Ft().$t()), r2.ot[0].wt = n, r2.ot[0]._t = s.jt(n), r2.lt = V) : r2.lt = null;
    });
  }
};
...
var W = class {
  ...
  hi(t, i, n, s) {
    ...
    S2 % 2 != b2 % 2 && (S2 += 1);
    const x2 = _2 > 0 ? Math.max(1, Math.floor(_2 * a2)) : 0, C2 = Math.round(g2 * a2), y2 = Math.round(o2 * a2), k2 = (_b = (_a2 = this.ei.Vi) != null ? _a2 : this.ei.Bi) != null ? _b : this.ei.Ei, P2 = Math.round(k2 * l2) - Math.floor(0.5 * l2), T2 = Math.floor(P2 + b2 / 2 - S2 / 2), R2 = T2 + S2, D2 = "right" === s, I2 = D2 ? h2.width - _2 : _2, V2 = D2 ? r2.width - x2 : x2;
    let B2, E2, A2;
...
var H = class {
  ...
  Wi() {
    var _a2;
    return (_a2 = this.Ai.Vi) != null ? _a2 : null;
  }
  Hi() {
    var _a2, _b;
    return (_b = (_a2 = this.Ai.Vi) != null ? _a2 : this.Ai.Bi) != null ? _b : this.Ei();
  }
  Ui(t) {
    this.Ai.Bi = t != null ? t : void 0;
  }
  $i() {
...
var Z = class extends Y {
  ...
  Nn() {
    this.sn.Zn().forEach((t) => {
      var _a2, _b;
      (_a2 = this.Mn.get(t)) == null ? void 0 : _a2.kt(), (_b = this.gn.get(t)) == null ? void 0 : _b.kt();
...
var lt = class extends R {
  ...
  Qs(t, i) {
    var _a2;
    if (!((_a2 = this.qt) == null ? void 0 : _a2.It)) return null;
...
var Ct = class {
  ...
  Nr(t, i, n, s = false, e2) {
    var _a2, _b;
    if (!s || !n || !e2) return { Wr: t.Wr, Hr: i.$n, Ur: t.Ur, $r: i.wt, jr: t.jr, qr: t.qr > i.Wt[1] ? t.qr : i.Wt[1], Yr: t.Yr < i.Wt[2] ? t.Yr : i.Wt[2], Kr: i.Wt[3], Zr: t.Zr + ((_a2 = i.Zr) != null ? _a2 : 1), Gr: t.Gr, zr: false };
    ...
    return { Wr: t.Wr, Hr: i.$n, Ur: t.Ur, $r: i.wt, jr: t.jr, qr: Math.max(t.qr, _2), Yr: Math.min(t.Yr, _2), Kr: _2, Zr: t.Zr + ((_b = i.Zr) != null ? _b : 1), Gr: l2, zr: false };
  }
  ...
  Or(t, i = false) {
    var _a2;
    return { Wr: t.$n, Hr: t.$n, Ur: t.wt, $r: t.wt, jr: t.Wt[0], qr: t.Wt[1], Yr: t.Wt[2], Kr: t.Wt[3], Zr: (_a2 = t.Zr) != null ? _a2 : 1, Gr: t.ue, zr: i };
  }
  kr(t) {
...
var kt = { Bar: (t, i, n, s) => {
  ...
  return { sh: (_a2 = h2.R) != null ? _a2 : a2 ? e2 : r2 };
}, Candlestick: (t, i, n, s) => {
  var _a2, _b, _c;
  ...
  return { sh: (_a2 = _2.R) != null ? _a2 : d2 ? e2 : r2, eh: (_b = _2.Ht) != null ? _b : d2 ? h2 : a2, rh: (_c = _2.hh) != null ? _c : d2 ? l2 : o2 };
}, Custom: (t, i, n, s) => {
  var _a2;
  return { sh: (_a2 = u(t(n, s)).R) != null ? _a2 : i.color };
}, Area: (t, i, n, s) => {
  var _a2, _b, _c, _d;
  const e2 = u(t(n, s));
  return { sh: (_a2 = e2.vt) != null ? _a2 : i.lineColor, vt: (_b = e2.vt) != null ? _b : i.lineColor, ah: (_c = e2.ah) != null ? _c : i.topColor, oh: (_d = e2.oh) != null ? _d : i.bottomColor };
}, Baseline: (t, i, n, s) => {
  var _a2, _b, _c, _d, _e, _f;
  const e2 = u(t(n, s));
  return { sh: e2.Wt[3] >= i.baseValue.price ? i.topLineColor : i.bottomLineColor, _h: (_a2 = e2._h) != null ? _a2 : i.topLineColor, uh: (_b = e2.uh) != null ? _b : i.bottomLineColor, dh: (_c = e2.dh) != null ? _c : i.topFillColor1, fh: (_d = e2.fh) != null ? _d : i.topFillColor2, ph: (_e = e2.ph) != null ? _e : i.bottomFillColor1, mh: (_f = e2.mh) != null ? _f : i.bottomFillColor2 };
}, Line: (t, i, n, s) => {
  var _a2, _b;
  const e2 = u(t(n, s));
  return { sh: (_a2 = e2.R) != null ? _a2 : i.color, vt: (_b = e2.R) != null ? _b : i.color };
}, Histogram: (t, i, n, s) => {
  var _a2;
  return { sh: (_a2 = u(t(n, s)).R) != null ? _a2 : i.color };
} };
...
var zt = class {
  ...
  qh(t, i, n) {
    var _a2, _b;
    (_b = (_a2 = this.jh).drawBackground) == null ? void 0 : _b.call(_a2, t, Lt);
  }
};
var Ot = class {
  constructor(t) {
  ...
  Tt() {
    ...
    if (null === t) return null;
    if (((_a2 = this.Ls) == null ? void 0 : _a2.Kh) === t) return this.Ls.Zh;
    const i = new zt(t);
    return this.Ls = { Kh: t, Zh: i }, i;
  }
  Gh() {
    var _a2, _b, _c;
    return (_c = (_b = (_a2 = this.Yh).zOrder) == null ? void 0 : _b.call(_a2)) != null ? _c : "normal";
  }
};
var Nt = class {
  constructor(t) {
  ...
  Nn() {
    var _a2, _b;
    (_b = (_a2 = this.Jh).updateAllViews) == null ? void 0 : _b.call(_a2);
  }
  jn() {
    var _a2, _b, _c, _d;
    const t = (_c = (_b = (_a2 = this.Jh).paneViews) == null ? void 0 : _b.call(_a2)) != null ? _c : [];
    if (((_d = this.Xh) == null ? void 0 : _d.Kh) === t) return this.Xh.Zh;
    const i = t.map((t2) => new Ot(t2));
    return this.Xh = { Kh: t, Zh: i }, i;
  }
  Qs(t, i) {
    var _a2, _b, _c;
    return (_c = (_b = (_a2 = this.Jh).hitTest) == null ? void 0 : _b.call(_a2, t, i)) != null ? _c : null;
  }
};
...
function Ut(t) {
  var _a2, _b, _c, _d, _e;
  return { ri: t.text(), Ei: t.coordinate(), Vi: (_a2 = t.fixedCoordinate) == null ? void 0 : _a2.call(t), R: t.textColor(), G: t.backColor(), It: (_c = (_b = t.visible) == null ? void 0 : _b.call(t)) != null ? _c : true, pi: (_e = (_d = t.tickVisible) == null ? void 0 : _d.call(t)) != null ? _e : true };
}
var $t = class {
  constructor(t, i) {
...
var qt = class extends Nt {
  ...
  dn() {
    var _a2, _b, _c, _d;
    const t = (_c = (_b = (_a2 = this.Jh).timeAxisViews) == null ? void 0 : _b.call(_a2)) != null ? _c : [];
    if (((_d = this.na) == null ? void 0 : _d.Kh) === t) return this.na.Zh;
    const i = this.Te.Qt().Et(), n = t.map((t2) => new $t(t2, i));
    return this.na = { Kh: t, Zh: n }, n;
  }
  qn() {
    var _a2, _b, _c, _d;
    const t = (_c = (_b = (_a2 = this.Jh).priceAxisViews) == null ? void 0 : _b.call(_a2)) != null ? _c : [];
    if (((_d = this.sa) == null ? void 0 : _d.Kh) === t) return this.sa.Zh;
    const i = this.Te.Ft(), n = t.map((t2) => new jt(t2, i));
    return this.sa = { Kh: t, Zh: n }, n;
  }
  ha() {
    var _a2, _b, _c, _d;
    const t = (_c = (_b = (_a2 = this.Jh).priceAxisPaneViews) == null ? void 0 : _b.call(_a2)) != null ? _c : [];
    if (((_d = this.ea) == null ? void 0 : _d.Kh) === t) return this.ea.Zh;
    const i = t.map((t2) => new Ht(t2));
    return this.ea = { Kh: t, Zh: i }, i;
  }
  aa() {
    var _a2, _b, _c, _d;
    const t = (_c = (_b = (_a2 = this.Jh).timeAxisPaneViews) == null ? void 0 : _b.call(_a2)) != null ? _c : [];
    if (((_d = this.ra) == null ? void 0 : _d.Kh) === t) return this.ra.Zh;
    const i = t.map((t2) => new Ht(t2));
    return this.ra = { Kh: t, Zh: i }, i;
  }
  la(t, i) {
    var _a2, _b, _c;
    return (_c = (_b = (_a2 = this.Jh).autoscaleInfo) == null ? void 0 : _b.call(_a2, t, i)) != null ? _c : null;
  }
};
function Yt(t, i, n, s) {
  t.forEach((t2) => {
...
var Jt = class extends yt {
  ...
  Ha() {
    ...
    if (n) return n;
    this.Ua(i);
    return (_a2 = this.va.get(i)) != null ? _a2 : this.qt;
  }
  $a(t) {
  ...
  Kh() {
    ...
    return (_a2 = t.base) != null ? _a2 : 1 / t.minMove;
  }
  tl() {
    return this.il;
  }
  Nn() {
    ...
    this.dr.kt(), this._a.kt(), (_a2 = this.ua) == null ? void 0 : _a2.kt(), this.fa.forEach((t) => t.Nn());
  }
  Ft() {
    return u(super.Ft());
  }
  ...
  Ma() {
    ...
    switch (this.yn.priceFormat.type) {
      case "custom": {
        ...
        this.il = { format: t, formatTickmarks: (_a2 = this.yn.priceFormat.tickmarksFormatter) != null ? _a2 : (i) => i.map(t) };
        break;
      }
      case "volume":
  ...
  ml() {
    ...
    return { fl: i, pl: n, vl: (_b = (_a2 = this.yn.conflationThresholdFactor) != null ? _a2 : s) != null ? _b : 1 };
  }
  wl(t) {
    const i = this.qt.Bh();
    let n;
  ...
  Da(t) {
    ...
    for (const n of i) {
      ...
      ((_a2 = s == null ? void 0 : s.Sl) == null ? void 0 : _a2.bl) ? s.Sl.bl(() => {
        i2();
...
var Ci = class {
  ...
  v_(t, i) {
    ...
    return this.S_(t, (_a2 = this.Po.tickmarksPriceFormatter) != null ? _a2 : n ? (t2) => t2.map(n) : void 0, i);
  }
  f_(t, i) {
  ...
  p_(t, i) {
    ...
    return this.S_(t, (_a2 = this.Po.tickmarksPercentageFormatter) != null ? _a2 : n ? (t2) => t2.map(n) : void 0, i);
  }
};
function yi(t) {
...
var ki = class {
  ...
  Pn() {
    ...
    const [t, i] = this.nu();
    let n = null;
    return t.N().visible && 0 !== t.Cl().length ? n = t : i.N().visible && 0 !== i.Cl().length ? n = i : 0 !== this.mo.length && (n = this.mo[0].Ft()), null === n && (n = (_a2 = this.Gs()) != null ? _a2 : t), n;
  }
  Gs() {
    const [t, i] = this.nu();
  ...
  au() {
    var _a2;
    const t = this.Dt(), i = (_a2 = this.sn.ou()) == null ? void 0 : _a2.lu, n = this.sn.N().hoveredSeriesOnTop, s = this.k_;
...
function Ri(t) {
  var _a2, _b, _c;
  return { ne: (_a2 = t.distance) != null ? _a2 : 0, se: (_b = t.hitTestPriority) != null ? _b : "marker" === t.itemType ? 2 : 0, ee: (_c = t.itemType) != null ? _c : "primitive", mu: t.cursorStyle, te: t.externalId };
}
function Di(t) {
  var _a2;
  return { lu: t.lu, wu: Ti(t.Mu), mu: t.Mu.mu, ee: (_a2 = t.Mu.ee) != null ? _a2 : "primitive" };
}
function Ii(t, i, n, s) {
  var _a2, _b;
  let e2 = null;
  for (const r2 of t) {
    let t2 = (_b = (_a2 = r2.Qs) == null ? void 0 : _a2.call(r2, i, n, s)) != null ? _b : null;
    if (null === t2) {
      const e3 = r2.Tt(s);
...
function Bi(t, i, n) {
  ...
  const s = [t, ...t.Dt()].reverse(), e2 = function(t2, i2, n2) {
    ...
    let s2, e3, r3;
    for (const l2 of t2) {
      const t3 = (_b = (_a3 = l2.Ja) == null ? void 0 : _a3.call(l2, i2, n2)) != null ? _b : [];
      for (const i3 of t3) {
        const t4 = Ri(i3);
        h3 = i3.zOrder, a2 = s2 == null ? void 0 : s2.zOrder, (!a2 || "top" === h3 && "top" !== a2 || "normal" === h3 && "bottom" === a2 || i3.zOrder === (s2 == null ? void 0 : s2.zOrder) && void 0 !== e3 && Pi(t4, e3) || i3.zOrder === (s2 == null ? void 0 : s2.zOrder) && void 0 === e3) && (s2 = i3, e3 = t4, r3 = l2);
      }
    }
    var h3, a2;
    return s2 && r3 && e3 ? { Mu: e3, bu: s2, lu: r3 } : null;
  }(s, i, n);
  if ("top" === (e2 == null ? void 0 : e2.bu.zOrder)) return Di(e2);
  let r2 = null, h2 = null;
  for (const a2 of s) {
    if (e2 && e2.lu === a2 && "bottom" !== e2.bu.zOrder && !e2.bu.isBackground) return r2 != null ? r2 : Di(e2);
    if (Vi(a2)) {
      const s2 = Ii(a2.jn(t), i, n, t);
      if (null !== s2) {
        const t2 = { lu: a2, gu: s2.gu, wu: Ti(s2.Mu), mu: s2.Mu.mu, ee: (_a2 = s2.Mu.ee) != null ? _a2 : "primitive" };
        (null === r2 || Pi(s2.Mu, h2)) && (r2 = t2, h2 = s2.Mu);
      }
    }
    if (e2 && e2.lu === a2 && "bottom" !== e2.bu.zOrder && e2.bu.isBackground) return r2 != null ? r2 : Di(e2);
  }
  return null !== r2 ? r2 : (e2 == null ? void 0 : e2.bu) ? Di(e2) : null;
}
var Ei = class {
...
var Fi = class {
  ...
  vr(t, i) {
    var _a2;
    f(this.yn, t), this.yn.fixLeftEdge && this.dc(), this.yn.fixRightEdge && this.fc(), void 0 !== t.barSpacing && this.sn.Ms(t.barSpacing), void 0 !== t.rightOffset && this.sn.gs(t.rightOffset), this.ac(t), void 0 === t.minBarSpacing && void 0 === t.maxBarSpacing || this.sn.Ms((_a2 = t.barSpacing) != null ? _a2 : this.hc), void 0 !== t.ignoreWhitespaceIndices && t.ignoreWhitespaceIndices !== this.yn.ignoreWhitespaceIndices && this._c(), this.cc(), this.lc(), void 0 === t.enableConflation && void 0 === t.conflationThresholdFactor || this.oc(), this.Xu.p();
  }
  Rn(t) {
    var _a2, _b;
    return (_b = (_a2 = this.$u[t]) == null ? void 0 : _a2.time) != null ? _b : null;
  }
  en(t) {
    var _a2;
    return (_a2 = this.$u[t]) != null ? _a2 : null;
  }
  vc(t, i) {
  ...
  oc() {
    ...
    const t = 1 / (window.devicePixelRatio || 1) * ((_a2 = this.yn.conflationThresholdFactor) != null ? _a2 : 1);
...
var qi = class {
  ...
  kd(t) {
    ...
    if (((_a2 = this.dd) == null ? void 0 : _a2.lu) === (t == null ? void 0 : t.lu) && ((_c = (_b = this.dd) == null ? void 0 : _b.wu) == null ? void 0 : _c.te) === ((_d = t == null ? void 0 : t.wu) == null ? void 0 : _d.te) && ((_f = (_e = this.dd) == null ? void 0 : _e.wu) == null ? void 0 : _f.ie) === ((_g = t == null ? void 0 : t.wu) == null ? void 0 : _g.ie) && ((_h = this.dd) == null ? void 0 : _h.mu) === (t == null ? void 0 : t.mu) && ((_i2 = this.dd) == null ? void 0 : _i2.ee) === (t == null ? void 0 : t.ee)) return;
    const i = this.dd;
    this.dd = t, null !== i && this.Ta(i.lu), null !== t && t.lu !== (i == null ? void 0 : i.lu) && this.Ta(t.lu);
  }
  N() {
    return this.yn;
  }
  ...
  lf(t) {
    ...
    this.od.push(i);
    const n = t != null ? t : this.od.length - 1, s = X.ys();
...
var cn = class {
  ...
  static yf(t) {
    return f({ localization: { dateFormat: "dd MMM 'yy" } }, t != null ? t : {});
  }
};
...
function In(t) {
  var _a2;
  t.width = 1, t.height = 1, (_a2 = t.getContext("2d")) == null ? void 0 : _a2.clearRect(0, 0, 1, 1);
}
function Vn(t, i, n, s) {
  t.qh && t.qh(i, n, s);
}
...
function An(t, i) {
  return (n) => {
    ...
    return ((_b = (_a2 = n.Ft()) == null ? void 0 : _a2.cl()) != null ? _b : "") !== i ? [] : (_d = (_c = n.Ga) == null ? void 0 : _c.call(n, t)) != null ? _d : [];
  };
}
function Ln(t, i, n, s) {
  if (!t.length) return;
...
var zn = class {
  ...
  kt() {
    var _a2;
    (_a2 = this.Ki) == null ? void 0 : _a2.El();
  }
  Mv(t) {
  ...
  Im(t) {
    ...
    n.borderVisible && n.ticksVisible && t.useBitmapCoordinateSpace(({ context: t2, horizontalPixelRatio: r2, verticalPixelRatio: h2 }) => {
      ...
      var _a2;
      t2.font = this.Sm(), t2.fillStyle = (_a2 = n.textColor) != null ? _a2 : this.ko.textColor, t2.textAlign = this.om ? "right" : "left", t2.textBaseline = "middle";
...
function On(t, i) {
  var _a2, _b;
  return (_b = (_a2 = t.Ka) == null ? void 0 : _a2.call(t, i)) != null ? _b : [];
}
function Nn(t, i) {
  var _a2, _b;
  return (_b = (_a2 = t.jn) == null ? void 0 : _a2.call(t, i)) != null ? _b : [];
}
function Fn(t, i) {
  var _a2, _b;
  return (_b = (_a2 = t.cn) == null ? void 0 : _a2.call(t, i)) != null ? _b : [];
}
function Wn(t, i) {
  var _a2, _b;
  return (_b = (_a2 = t.ja) == null ? void 0 : _a2.call(t, i)) != null ? _b : [];
}
var Hn = class _Hn {
  constructor(i, n) {
  ...
  iw(t) {
    var _a2, _b;
    null !== this.Zm && this.Zm.fu().u(this), this.Zm = t, null !== this.Zm && this.Zm.fu().i(_Hn.prototype.Gm.bind(this), this, true), this.tw(), this.qv.rv().indexOf(this) === this.qv.rv().length - 1 ? (this.Om = (_a2 = this.Om) != null ? _a2 : new Rn(this.Xm, this.qv), this.Om.kt()) : ((_b = this.Om) == null ? void 0 : _b.Kv(), this.Om = null);
  }
  am() {
    return this.qv;
  }
...
function $n(t) {
  return (i) => {
    var _a2, _b;
    return (_b = (_a2 = i.Xa) == null ? void 0 : _a2.call(i, t)) != null ? _b : [];
  };
}
var jn = $n("normal");
var qn = $n("top");
...
var _a;
var Zn = !!dn && !!navigator.userAgentData && navigator.userAgentData.brands.some((t) => t.brand.includes("Chromium")) && !!dn && (((_a = navigator == null ? void 0 : navigator.userAgentData) == null ? void 0 : _a.platform) ? "Windows" === navigator.userAgentData.platform : navigator.userAgent.toLowerCase().indexOf("win") >= 0);
var Gn = class {
  constructor(t, i, n) {
    var s;
  ...
  vr(t) {
    ...
    this.sn.vr(t);
    const n = Xn(this.yn);
    n !== i && this.lM(n), ((_a2 = t.layout) == null ? void 0 : _a2.panes) && this.gM(), this.fM(), this.bM(t);
  }
  dw() {
    return this.Wm;
  }
  ...
  MM(t, i) {
    ...
    3 === n && this.VM(), 3 !== n && 2 !== n || (this.BM(t), this.EM(t, i), this._M.kt(), this.Gw.forEach((t2) => {
      t2.sw();
    }), 3 === ((_a2 = this.iM) == null ? void 0 : _a2.ls()) && (this.iM.Ss(t), this.VM(), this.BM(this.iM), this.EM(this.iM, i), t = this.iM, this.iM = null)), this.km(t);
  }
  EM(t, i) {
  ...
  zM(t, i, n, s) {
    ...
    let r2;
    if (null !== t) {
      const i2 = (_a2 = this.sn.Et().en(t)) == null ? void 0 : _a2.originalTime;
      void 0 !== i2 && (r2 = i2);
    }
    const h2 = this.Qt().ou(), a2 = this.OM(s), l2 = function(t2, i2) {
      var _a3;
      const n2 = null !== t2 && t2.lu instanceof Jt ? t2.lu : void 0, s2 = (_a3 = t2 == null ? void 0 : t2.wu) == null ? void 0 : _a3.te, e3 = void 0 !== i2 && -1 !== i2 ? i2 : void 0;
    ...
    return { Qr: r2, $n: t != null ? t : void 0, qM: i != null ? i : void 0, jM: -1 !== a2 ? a2 : void 0, NM: l2.NM, YM: e2, FM: l2.FM, WM: l2.WM, KM: n != null ? n : void 0 };
  }
  OM(t) {
    let i = -1;
  ...
  oM(t, i, n) {
    var _a2, _b;
    this.PM((_b = (_a2 = this.Qt().ou()) == null ? void 0 : _a2.mu) != null ? _b : null), this.pd.p(() => this.zM(t, i, n));
  }
  fM() {
...
var Vs = class extends Rs {
  ...
  Pg(t, i) {
    var _a2, _b;
    const n = (_b = (_a2 = this.Eg).hitTest) == null ? void 0 : _b.call(_a2, t, i, (t2) => this.Ag(t2));
...
var Xs = class {
  constructor(t, i, n) {
    this.sv = t, this.zg = i, this.Og = n != null ? n : 0;
  }
  applyOptions(t) {
...
var Js = class {
  ...
  getSeries() {
    var _a2;
    return (_a2 = this.yt.U_().map((t) => this.Ng(t))) != null ? _a2 : [];
  }
  getHTMLElement() {
    const t = this.sv.rv();
...
var SAMPLE_CANDLES = [
  ...
  { time: 170424e4, open: 45418, high: 45700, low: 43515, close: 43831, volume: 47892 },
  ...
  { time: 1704672e3, open: 42800, high: 43124, low: 41521, close: 41762, volume: 61234 },
  { time: 1704758400, open: 41762, high: 43e3, low: 41200, close: 42738, volume: 49876 },
  ...
  { time: 1705104e3, open: 45675, high: 46450, low: 44900, close: 45890, volume: 58923 },
  ...
  { time: 1705536e3, open: 42180, high: 42600, low: 40500, close: 41200, volume: 68912 },
...
function renderKlineChart(container, candles) {
  container.empty();
  const data = candles != null ? candles : SAMPLE_CANDLES;
  ...
  const candleSeries = chart.addSeries(Ge, {
    upColor: "#26a69a",
    downColor: "#ef5350",
    borderVisible: false,
    wickUpColor: "#26a69a",
  ...
  const volumeSeries = chart.addSeries(Qe, {
  ...
  volumeSeries.setData(
    data.map((c2) => ({
      time: c2.time,
      value: c2.volume,
      color: c2.close >= c2.open ? "#26a69a60" : "#ef535060"
    }))
  );
